...
def build_model():
    model = Sequential()
    model.add(Convolution2D(6, (5, 5), padding='valid', activation = 'relu', kernel_initializer='he_normal', kernel_regularizer=l2(weight_decay), input_shape=(3,32,32)))
    model.add(MaxPooling2D((2, 2), strides=(2, 2)))
    model.add(Convolution2D(16, (5, 5), padding='valid', activation = 'relu', kernel_initializer='he_normal', kernel_regularizer=l2(weight_decay)))
    model.add(MaxPooling2D((2, 2), strides=(2, 2)))
    model.add(Flatten())
