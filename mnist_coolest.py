...
def baseline_model():
    # create model
    model = Sequential()
    model.add(Convolution2D(5, 5, 5, input_shape=(1, 28, 28), kernel_initializer= 'glorot_uniform' , kernel_constraint=max_norm(1.), bias_constraint=max_norm(0.4), activation='relu'))
